...
const injectHero = () => {
    const heroImg = `<img src="/pages/NTSG/assets/images/homepageHero.png" class="img-fluid" alt="New-To-Strings Guide: A compilation of expert teaching, useful resources, reproducible materials,
