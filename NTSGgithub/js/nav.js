...
const injectNav = () => {
    const nav = `<nav class="navbar navbar-expand-lg bg-body-tertiary mb-3 p-3">
            <div class="container-fluid">
                <img src="/NTSGgithub/assets/images/NTSGlogo.png" alt="Logo" href="#" height="60px"
                    class="d-inline-block align-text-center">
                <a class="navbar-brand px-3" href="/NTSGgithub/index.html" style="font-size: xx-large;">New to Strings
                    Guide</a>
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" style="text-align: center;"
                                    href="/NTSGgithub/pages/maintaining.html">Maintaining an
                                    Orchestra</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                    href="/NTSGgithub/pages/pedagogy/pedagogy.html" role="button"
                                    aria-expanded="false">Pedagogy</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="/NTSGgithub/pages/pedagogy/pedagogy.html">Overview</a></li>
                                    <li><a class="dropdown-item" href="/NTSGgithub/pages/pedagogy/violin-pedagogy.html">Violin</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/NTSGgithub/pages/pedagogy/viola-pedagogy.html">Viola</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/NTSGgithub/pages/pedagogy/cello-pedagogy.html">Cello</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/NTSGgithub/pages/pedagogy/bass-pedagogy.html">Bass</a>
                                    </li>
                                    <li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/NTSGgithub/pages/tools.html">Useful Tools</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/NTSGgithub/pages/resources.html">Resources</a>
                            </li>
